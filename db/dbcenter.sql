...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jan 2022 pada 08.39
...
CREATE TABLE `tbperson` (
  ...
  `rata_rata_nilai_rapor_kelas_12` int(100) NOT NULL,
  `pilih_program_studi_1` varchar(100) NOT NULL,
  `pilih_program_studi_2` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `tbperson`
--

INSERT INTO `tbperson` (`id`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `kewarganegaraan`, `agama`, `nama_ibu`, `email`, `no_telepon`, `alamat`, `kode_pos`, `provinsi`, `kabupaten`, `kecamatan`, `pendidikan_terakhir`, `nama_sekolah`, `rata_rata_nilai_rapor_kelas_12`, `pilih_program_studi_1`, `pilih_program_studi_2`) VALUES
(10519069, 'Ilman Mochamad Andriansyah', 'Bandung', 2000, 'Laki-laki', 'WNI', 'Islam', 'Eveline', 'Ilman@gmail.com', 2147483647, 'Jalan Garuda No.69', 6969, '32', '3204', '320409', 'SMK-IPA', 'SMKN 1 Katapang', 100, 'S1 - Sistem Informasi', 'S1 - Teknik Informatika');
